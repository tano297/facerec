...
if __name__ == '__main__':
    ...
    ap = argparse.ArgumentParser("This sample demonstrates SEEDS Superpixels segmentation. Use [space] to toggle output mode")
    ...
    if img == None:
        print("Cannot open image. Exiting...")
        quit()
